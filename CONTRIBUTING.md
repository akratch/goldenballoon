...
`MDKR_RENDERER=webgpu|gl` selects the backend — OpenGL is the native default and
WebGPU remains available for parity work. The browser build is WebGPU-only; see
