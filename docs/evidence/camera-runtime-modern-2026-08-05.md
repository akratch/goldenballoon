...
4. Exact work is allocation-free and bounded. Healthy sphere exhaustion is a
   conservative hit, never a clear; malformed cache/generation/input remains
   invalid.
