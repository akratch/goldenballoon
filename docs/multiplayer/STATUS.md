...
| LC-10 | EVIDENCE REVIEW | Bounded queues, 250 ms neutral, lifecycle release and reconnect epochs pass automation; physical background/network-loss matrix remains. |
