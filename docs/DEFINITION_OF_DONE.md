...
| The camera stays out of walls, by default | Default-on with the per-family treatment table. Chatter 0, shoulder flips 0, retract latency 0 ticks, emergency framing 46 frames across the 24-arm display matrix (was 1,585), 4P finalizer p99 130 µs against an 833 µs budget. Original camera one setting away; reduced-motion option ships alongside. |
