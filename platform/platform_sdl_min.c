 ...
 * Resolved once from MDKR_RENDERER (webgpu|gl|metal), default GL. Validated
...
int mdkr_render_backend(void) {
    ...
    int want = MDKR_BACKEND_GL;   /* native throughput default */
    if (e && e[0]) {
...
uint64_t platform_vi_present_pace_units(void) {
    ...
    if (s_paceMode == PACE_SYNTH) {
        ...
        if (now > s_presentLastNs &&
            now - s_presentLastNs > UINT64_C(250000000)) {
